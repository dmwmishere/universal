 ...
 * 2017-04-16T13:57:50.379+03:00
 * Generated source version: 3.1.3
 * 
 */
@WebServiceClient(name = "GlobalWeather", 
                  wsdlLocation = "file:/home/dmwm/Java-projects/CamelSample/External/src/main/resources/xsds/globalweather.asmx",
...
public class GlobalWeather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/dmwm/Java-projects/CamelSample/External/src/main/resources/xsds/globalweather.asmx");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GlobalWeather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/dmwm/Java-projects/CamelSample/External/src/main/resources/xsds/globalweather.asmx");
        }
        WSDL_LOCATION = url;
    }
